...
function App() {
  ...
  return (
    <div className="grid place-content-center h-[100vh] bg-[url(./bg-2.jpg)] bg-cover bg-center">
      <div className="md:scale-[1.4] bg-black h-[147.5mm] w-[71.5mm] rounded-[2rem] overflow-hidden border-8 border-black relative grid justify-items-center text-black/60">
